defmodule Arbor.Identifiers do
  ...
  ## Examples
      ...
      iex> agent_id = Arbor.Identifiers.generate_agent_id()
  ...
  ## Examples
      ...
      iex> session_id = Arbor.Identifiers.generate_session_id()
  ...
  ## Examples
      ...
      iex> cap_id = Arbor.Identifiers.generate_capability_id()
  ...
  ## Examples
      ...
      iex> trace_id = Arbor.Identifiers.generate_trace_id()
  ...
  ## Examples
      ...
      iex> exec_id = Arbor.Identifiers.generate_execution_id()
