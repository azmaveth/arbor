defmodule Arbor.Contracts.Cluster.Coordinator do
  ...
  """
  @callback calculate_distribution(workload :: term(), strategy :: distribution_strategy(), state()) :: 
  ...
  """
  @callback handle_split_brain(partition_info :: map(), state()) :: {:ok, state()} | {:error, term()}
