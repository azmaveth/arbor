defmodule Arbor.Core.AgentCheckpointTest do
  ...
  describe "stateful agent recovery" do
    test "stateful agent recovers state after restart" do
      ...
      :timer.sleep(200)  # Allow checkpoint to complete
      ...
      end, "Agent should be restarted by reconciler")
    ...
    test "agent without checkpoint behavior starts normally" do
      ...
      agent_spec = %{
        id: agent_id,
        module: TestPersistentAgent,  # From declarative_supervision_test.exs
        args: [agent_id: agent_id],
        restart_strategy: :permanent
      }
      ...
      end, "Non-checkpointing agent should restart normally")
