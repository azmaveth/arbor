defmodule Arbor.Agents.CodeAnalyzer do
  ...
  # Suppress Dialyzer warnings for defensive error handling generated by AgentBehavior
  # The macro generates handle_restore_result/2 with error clauses that are unreachable
  # when restore_state/2 always returns {:ok, _}
  @dialyzer {:nowarn_function, handle_restore_result: 2}
